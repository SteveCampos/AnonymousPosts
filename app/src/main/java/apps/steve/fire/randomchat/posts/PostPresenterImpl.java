...
import apps.steve.fire.randomchat.posts.usecase.GetPostWithTag;
import apps.steve.fire.randomchat.posts.usecase.GetRecentPosts;

import static apps.steve.fire.randomchat.posts.PostsFragment.EXTRA_TAG;
import static apps.steve.fire.randomchat.posts.PostsFragment.EXTRA_TYPE;
import static apps.steve.fire.randomchat.posts.PostsFragment.TYPE_HASHTAG;
import static apps.steve.fire.randomchat.posts.PostsFragment.TYPE_POPULAR;
import static apps.steve.fire.randomchat.posts.PostsFragment.TYPE_RECENTS;
